    ...
    <SafeAreaView style={{ paddingTop: Platform.OS === "android" ? 40 : 0, flex: 1, backgroundColor: "white" }}>
        <ScrollView>
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                {list.map((item, index) => (
                    <Pressable key={index} onPress={() => console.log('pressed!!!')} style={{ margin: 10, justifyContent: "center", alignItems: "center" }}>
            ...
            <SliderBox images={images} autoPlay circleLoop dotColor={"#12374F"} inactivateDotColor="#90A4AE" ImageComponentStyle={{ width: "100%" }}/>
